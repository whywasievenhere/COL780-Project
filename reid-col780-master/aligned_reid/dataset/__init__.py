...
def create_dataset(
    ...
    part='trainval',
    **kwargs):
  assert name in ['market1501', 'cuhk03', 'duke', 'combined','other'], \
  ...
  if name == 'market1501':
    ...
    im_dir = ospeu('/Users/shreyansnagori/desktop/reid-col780-master/data')
    partition_file = ospeu('/Users/shreyansnagori/desktop/reid-col780-master/partitions.pkl')
  ...
  cmc_kwargs = dict(separate_camera_set=True,
